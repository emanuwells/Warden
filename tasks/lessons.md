...
**Contexto:** O repo Warden já tinha uma estrutura `.agents/` madura com policies, ops, mcp e skills. O template de governança IA sénior tinha componentes complementares em `docs/ai/` e `docs/architecture/` que não existiam no repo.  
